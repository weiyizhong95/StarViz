  ...
  return (
    <>
      <div className="track-info-panel">
        ...
        <span style={{ marginLeft: "30px", marginRight: "10px" }}>for</span>
        <InputNumber 
          min={1}
          max={50}
          defaultValue={1}
          ...
          disabled={disabled}
        />
        <span style={{ marginLeft: "10px", marginRight: "0x" }}>minutes</span>
        <Progress 
          style={{ width: "500px", marginRight: "70px" }}
      ...
      <div className="time-stamp-container" style={{textAlign: "center", marginLeft:"-700px" }}>
        <b>{currentTimestamp}</b>
      </div>
      <ComposableMap projectionConfig={{ scale: 137 }} style={{ height: "800px", marginLeft:"-60px", maxwidth: "80%", minWidth:"30%"}}>
